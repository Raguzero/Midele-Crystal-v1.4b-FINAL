...
PrimeapeEvosAttacks:
	...
	db 28, SUBMISSION
	db 31, SEISMIC_TOSS
	db 34, SHADOW_BALL ; New Exclusive Midele Move
	db 37, ENCORE
	db 41, CROSS_CHOP
	db 44, SCREECH
	db 47, BODY_SLAM
...
ArcanineEvosAttacks:
	...
	db 58, REVERSAL
	db 61, OUTRAGE
	db 70, SACRED_FIRE ; New Gold Spaceworld Beta Move
	db 0 ; no more level-up moves
...
SunfloraEvosAttacks:
	...
	db 25, GIGA_DRAIN
	db 28, SUNNY_DAY
	db 31, FLAMETHROWER ; New Exclusive Midele Move
	db 34, RECOVER ; New Exclusive Midele Move
	db 37, SOLARBEAM
	db 39, MIMIC
	db 41, PETAL_DANCE
	db 43, LIGHT_SCREEN
	db 46, FIRE_BLAST ; New Exclusive Midele Move
	db 0 ; no more level-up moves
