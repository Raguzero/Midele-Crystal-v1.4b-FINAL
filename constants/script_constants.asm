...
; MoveTutor writebyte arguments
	const_def 1
    const MOVETUTOR_MOVE1 ; 1
	const MOVETUTOR_MOVE2 ; 2
	const MOVETUTOR_MOVE3 ; 3
	const MOVETUTOR_MOVE4 ; 4

; MoveTutor move constants
	const_def
	const MOVETUTOR_MOVE_FLAMETHROWER
	const MOVETUTOR_MOVE_THUNDERBOLT
	const MOVETUTOR_MOVE_ICE_BEAM
	const MOVETUTOR_MOVE_SOFTBOILED
	const MOVETUTOR_MOVE_LOVELY_KISS
	const MOVETUTOR_MOVE_MOONLIGHT
	const MOVETUTOR_MOVE_MORNING_SUN
