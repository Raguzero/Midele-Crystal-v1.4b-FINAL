...
; New to Crystal
	...
	const EVENT_18 ; AVADER REMATCH USAN EL MISMO
	const EVENT_19 ; AVADER REMATCH USAN EL MISMO
	const EVENT_20 ; AVADER REMATCH USAN EL MISMO
	const EVENT_21 ; CATERMANO
